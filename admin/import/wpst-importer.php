...
function wpst_create_widgets() {  
    ...
    $sidebar_3 = array(
        'title'             => '',
        'text'              => '<div class="text-center"><a href="#"><img src="' . get_template_directory_uri() . '/assets/img/banners/square.jpg"></a></div>'
    );
    ...
    wpst_add_widget( 'homepage', 'text', 4, $home_4 );
    wpst_add_widget( 'homepage', 'widget_videos_block', 5, $home_5 );

    wpst_add_widget( 'sidebar', 'categories', 6, $sidebar_1 );
    wpst_add_widget( 'sidebar', 'widget_videos_block', 7, $sidebar_2 );
    wpst_add_widget( 'sidebar', 'text', 8, $sidebar_3 );

    wpst_add_widget( 'footer', 'widget_videos_block', 9, $footer_1 );
    wpst_add_widget( 'footer', 'text', 10, $footer_2 );
    wpst_add_widget( 'footer', 'text', 11, $footer_3 );
    wpst_add_widget( 'footer', 'widget_videos_block', 12, $footer_4 );
