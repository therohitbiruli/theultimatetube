...
if ( WPSCORE()->get_product_status( 'UTT' ) !== 'connected' ) {
	$message = __( 'Please purchase a Ultimatube plan - https://www.wp-script.com/adult-wordpress-themes/ultimatube/', 'wpst' );
	wpst_display_error_page( $message );
}
